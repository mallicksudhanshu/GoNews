...
class Activity_Science : AppCompatActivity(), NewsItemClicked {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerViewScience.layoutManager= LinearLayoutManager(this)
        fetchData()
        mAdapter=NewsListAdapter(this)
        recyclerViewScience.adapter=mAdapter
    }
