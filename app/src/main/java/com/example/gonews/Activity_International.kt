...
class Activity_International : AppCompatActivity(), NewsItemClicked {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerViewInternational.layoutManager= LinearLayoutManager(this)
        fetchData()
        mAdapter=NewsListAdapter(this)
        recyclerViewInternational.adapter=mAdapter
    }
