...
class Activity_Technology : AppCompatActivity(), NewsItemClicked {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recyclerViewTechnology.layoutManager= LinearLayoutManager(this)
        fetchData()
        mAdapter=NewsListAdapter(this)
        recyclerViewTechnology.adapter=mAdapter
    }
